...
(function ($) {
  ...
  var Selectpicker = function (element, options, e) {
    ...
    if (this.$element.attr('liveSearchPlaceholder') && this.$element.attr('liveSearchPlaceholder').trim() != '') {
      this.options.liveSearchPlaceholder = this.$element.attr('liveSearchPlaceholder');
    }
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var searchbox = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="input-block-level form-control" autocomplete="off" placeholder="' + (this.options.liveSearchPlaceholder) + '" /></div>' : '';

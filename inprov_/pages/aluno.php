...
<div class="" style="">
    <div class="col-md-12">
        <div class="col-md-6 col-sm-6 col-xs-8">
            <h3 style="font-style:italic">CADASTRO DE ALUNOS</h3>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-4 text-right">
            <button class="btn btn-primary" style="margin-top: 10px;" onclick="loadModal('aluno_');">Novo</button>
        </div>
    </div>
    <div class="">
        <script>
                ...
                <div class="search-panel col-md-6">
                    <div class="search-panel__inner" style="padding-left:15px">
                        <div class="search-field col-md-10 col-sm-12 col-xs-12 widget-cart2">
                            <input type="text" placeholder="Buscar aluno" name="filtrar" value="<?= $filtrar; ?>"/>
...
//                        var_dump($key);
                        ...
                        <tr>
                            ...
                            <td align="center"><span class="in-stock">$key->curso</span></td>
                            <td align="center"><span class="in-stock">$key->situacao</span></td>
                            <td align="center" onclick="loadModal('aluno_',{matricula: $key->matricula});"><a style="cursor: pointer;" class="basic1"><img src="img/editar.png" style="margin-top:-10px"></a></td>
                        </tr>
html;
                    }
                    ?> 
...
//                                        });
                                    ...
                                    <div class="pagination">
                                        <ul>
                                            ...
                                            echo $_paginator->fazPaginacao($Url, "onclick='fazPaginacao(this, event)' parr='aluno'");
                                            ?> 

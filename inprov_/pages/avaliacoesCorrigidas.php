...
switch ($Pessoa) {
    case 'A':
        switch ($Tipo) {
            case 'A':
                $_paginator->total_items = $Avaliacoes = ClsAvaliacao::selectAvaliacaoAplicadaAluno($parr);
                ...
                $Avaliacoes = ClsAvaliacao::selectAvaliacaoAplicadaAluno($parr);
                break;

            case 'C':
                $_paginator->total_items = $Avaliacoes = ClsAvaliacao::selectAvaliacaoCorrigidaAluno($parr);
                $pagination = $_paginator->paginate();
                ...
                $Avaliacoes = ClsAvaliacao::selectAvaliacaoCorrigidaAluno($parr);
                break;
    ...
    case 'P':
        switch ($Tipo) {
            case 'A':
                $_paginator->total_items = $Avaliacoes = ClsAvaliacao::selectAvaliacaoAplicadaProfessor($parr);
                $pagination = $_paginator->paginate();
                ...
                $Avaliacoes = ClsAvaliacao::selectAvaliacaoAplicadaProfessor($parr);
                break;

            case 'C':
                $_paginator->total_items = $Avaliacoes = ClsAvaliacao::selectAvaliacaoCorrigidaProfessor($parr);
                $pagination = $_paginator->paginate();
                ...
                $Avaliacoes = ClsAvaliacao::selectAvaliacaoCorrigidaProfessor($parr);
                break;
...
html;
                        ...
                        echo <<<html
                            ...
                            <td align="center" onclick="loadModal('avaliacoesAplicadas_',{avaliacao_id: $key->avaliacao_id});"><a style="cursor: pointer;" class="basic1"><img src="img/editar.png" style="margin-top:-10px"></a></td>
                        </tr>
html;
                    }
                    ?> 

...
html;
                        ...
                        $matricula = ($_SESSION['funcao_id'])?$key->matricula:$matricula;
                        
                        echo <<<html
                            </span></td>
                            <td align="center" onclick="loadModal('avaliacoesAplicadas_',{avaliacao_id: $key->avaliacao_id, matricula: $matricula});"><a style="cursor: pointer;" class="basic1"><img src="img/editar.png" style="margin-top:-10px"></a></td>
                        </tr>
html;
                    }
                    ?> 

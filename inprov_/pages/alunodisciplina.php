...
//                        var_dump($key);
                        ...
                        <tr>
                            ...
                            <td align="center" onclick="loadModal('alunodisciplina_',{matricula: $key->matricula});"><a style="cursor: pointer;" class="basic1"><img src="img/editar.png" style="margin-top:-10px"></a></td>
                        </tr>
html;
                    }
                    ?> 

...
$_paginator->total_items = $Assunto = ClsAssunto::selectAssunto($parr);
...
$Assunto = ClsAssunto::selectAssunto($parr);
?> 
...
<div class="" style="">
    <div class="col-md-12">
        ...
        <div class="col-md-6 col-sm-6 col-xs-4 text-right">
            <button class="btn btn-primary" style="margin-top: 10px;" onclick="loadModal('assunto_');">Novo</button>
        </div>
    </div>
    <div class="">
...
//                    var_dump($Assunto);
                    ...
                    foreach ($Assunto as $key) {
//                        var_dump($key);
                        echo <<<html
                        <tr style="border-bottom: 1px solid #dddddd;">
                            <td align="center"><span class="in-stock">$key->assunto_id</span></td>
                            <td align="center"><a>$key->assunto</a></td>
                            <td align="center" onclick="loadModal('assunto_',{assunto_id: $key->assunto_id});"><a style="cursor: pointer;" class="basic1"><img src="img/editar.png" style="margin-top:-10px"></a></td>
                        </tr>
html;
                    }
                    ?> 
...
<div id="modal" class="hid" style="width: 440px; height: 250px;">

...
<div class="" style="">
    <div class="col-md-12">
        <div class="col-md-6 col-sm-6 col-xs-8">
            <h3 style="font-style:italic">CADASTRO DE PROFESSORES</h3>
        </div>
        <div class="col-md-6 col-sm-6 col-xs-4 text-right">
            <button class="btn btn-primary" style="margin-top: 10px;" onclick="loadModal('professor_');">Novo</button>
        </div>
    </div>
    <div class="">
...
//                        var_dump($key);
                        ...
                        <tr>
                            ...
                            <td align="center" onclick="loadModal('professor_',{matricula: $key->matricula});"><a style="cursor: pointer;" class="basic1"><img src="img/editar.png" style="margin-top:-10px"></a></td>
                        </tr>
html;
                    }
                    ?> 
